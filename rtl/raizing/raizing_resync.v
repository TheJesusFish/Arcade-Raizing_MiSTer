...
/*  This file is part of Arcade-Raizing_MiSTer.
    ...
    Derived from JTFRAME jtframe_resync by Jose Tejada Gomez.
*/

module raizing_resync #(
...
wire [CNTW-1:0]  hpos_off = { {CNTW-HOFFW{hoffset[HOFFW-1]}}, hoffset };
wire [CNTW-1:0]  vpos_off = { {CNTW-VOFFW{voffset[VOFFW-1]}}, voffset };
