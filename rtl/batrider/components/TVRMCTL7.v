...
//text rom
raizing_dual_ram #(.DW(8), .AW(14)) u_textrom_lo(
    .clk0(CLK96),
    .clk1(CLK96),
...
raizing_dual_ram #(.DW(8), .AW(14)) u_textrom_hi(
    .clk0(CLK96),
    .clk1(CLK96),
...
raizing_dual_ram #(.DW(16), .AW(12)) u_textvram(
    .clk0(CLK96),
    .clk1(CLK96),
    .data0  (wr_dma_data),
...
raizing_dual_ram #(.DW(16), .AW(11)) u_paletteram(
    .clk0(CLK96),
    .clk1(CLK96),
    .data0  (wr_dma_data),
...
raizing_dual_ram #(.DW(16), .AW(8)) u_textselect(
    .clk0(CLK96),
    .clk1(CLK96),
    .data0  (wr_dma_data),
...
raizing_dual_ram #(.DW(16), .AW(8)) u_textscroll(
    .clk0(CLK96),
    .clk1(CLK96),
    .data0  (wr_dma_data),
    .addr0  (wr_dma_addr[7:0]),
...
raizing_dual_ram #(.DW(16), .AW(14)) u_textgfxram(
    .clk0(CLK96),
    .clk1(CLK96),
    .data0  (wr_dma_data),
    .addr0  (wr_dma_addr[13:0]),
