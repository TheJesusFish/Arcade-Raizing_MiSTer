...
reg last_VB = 0;
reg busy = 1'b0;
wire obj_line_start = (pedg_HB && !VB) ||
                      (((!FLIPX && VRENDER == 0) || (FLIPX && VRENDER == 239)) && pedg_HB);
...
reg [7:0] visited_pixels = 8'h0;
reg [7:0] sprite_nonzero_mask = 8'h0;
//processing vars
reg [3:0] priority_l;
...
raizing_dual_ram #(.DW(8), .AW(12)) u_sprite_pri_q(
    .clk0(CLK96),
    .clk1(CLK96),
    .data0  (wr_spr_q),
    .addr0  (wr_spr_q_addr),
...
`endif
                ...
                18: begin
                    ...
                    st<=sprite_nonzero_mask == 8'h00 ? 30 : 22;
                end
                22: begin //draw the slice, every slice is 8 pixels
                    ...
                    if(((visited_pixels & sprite_nonzero_mask) == sprite_nonzero_mask) || (xflip ? tx == 0 : tx == 7)) st<=30;
                    else st<=st;
                end
