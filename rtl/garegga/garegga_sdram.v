...
wire is_sdram_rom = is_cpu | is_snd | is_tile | is_pcm;
...
always @(posedge CLK) begin
    if(IOCTL_WR && !IOCTL_RAM) begin
		...
		end else if(is_sdram_rom) begin
			PROG_WE<=1'b1;
			pre_data <= IOCTL_DOUT;
...
//TEXT ROM
raizing_dual_ram16 #(.AW(14)) u_textrom(
	.clk0(CLK),
	.clk1(CLK),
    // loader
